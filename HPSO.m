        ...
        if populationQ(e).alive
            ...
            for n = 1:length(populationQ(e).member)
                ...
                if populationQ(e).member(n).alive
                    ...
                    populationQ(e).History(n) = [populationQ(e).History(n) populationQ(e).member(n).Cost];
                    k = length(populationQ(e).History(n));
                    hist = populationQ(e).History(n);
                    if std(hist(abs((k - 50):k))) < MinStdDev
